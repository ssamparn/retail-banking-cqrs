package com.eventsourcing.retailbanking.cqrs.bankaccountcore.config;
...
@Configuration
public class BankAccountCqrsAxonConfig {
    ...
    public EmbeddedEventStore eventStore(EventStorageEngine storageEngine,
        ...
        return EmbeddedEventStore.builder()
                ...
                .messageMonitor(configuration.getObject().messageMonitor(EventStore.class, "bankaccounteventstore"))
                .build();
    }
